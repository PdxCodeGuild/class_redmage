...
class AppyModel(models.Model):
    ...
    home_phone = models.IntegerField(null=False, blank=False, max_length=10)
    cell_phone = models.IntegerField(null=False, blank=False, max_length=10)
    ...
    current_employer_zip = models.IntegerField(null=False, blank=False, max_length=5)
    current_employer_phone = models.IntegerField(null=False, blank=False, max_length=10)
    ...
    previous_employer_zip = models.IntegerField(null=False, blank=False, max_length=5)
    previous_employer_phone = models.IntegerField(null=False, blank=False, max_length=75)
    ...
    add_question_dogs = models.IntegerFieldField(null=False, blank=False)
    add_question_cats = models.IntegerFieldField(null=False, blank=False)
