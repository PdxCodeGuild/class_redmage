...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """If date is in future, was_publshed_recently() should return False"""
    ...
    def test_was_published_recently_with_recent_question(self):
        """if date is within past day, was_published_recently() should return True"""
...
class QuestionIndexViewTests(TestCase):
    ...
    past questions > display on page
    future question > dsiplay error message
    one of each > display only past questions
    two past questions > display both/all past questions
    """
    ...
    def test_past_question(self):
        """
        if past question, dsplay on index page
        """
    ...
    def test_future_question_and_past_question(self):
        """
        if future question and a past question, only display past questions     """
        create_question(question_text="Past question?", days =-30)
        create_question(question_text="Future question?", days =30)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'],['<Question: Past question?>'])
    ...
    def test_two_past_questions(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'],['<Question: Past question?>','<Question: Another past question?>'])
