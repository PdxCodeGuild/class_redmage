...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        '''If date is in past, was_published_recently() should return False'''
    ...
    def test_was_published_recently_with_recent_question(self):
        '''If date is in range, was_published_recently() should return True'''
...
class QuestionIndexViewTest(TestCase):
    ...
    two past question > display both
    '''
    ...
    def test_future_question_and_past_question(self):
        ''' if a future and a past question only display past questions '''
    ...
    def test_two_past_questions(self):
        ...
        self.assertQuerysetEqual(
            response.context['latest_question_list'], ['<Question: Past question?>', '<Question: Another past question?>']
            )
